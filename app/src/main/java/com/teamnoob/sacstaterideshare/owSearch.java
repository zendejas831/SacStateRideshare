...
public class owSearch extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ow_activity_search);
...
//**************************Create Spinners/drop downs
        ...
        */
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(owSearch.this,
        ...
        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(owSearch.this,
        ...
        ArrayAdapter<String> adapter4 = new ArrayAdapter<String>(owSearch.this,
...
//**************************Create Buttons
        ...
        //TODO create 1 date pickers
        //TODO create 1 buttons for setting to time
